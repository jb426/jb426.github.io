      ...
      <div className="mainContainer">
        ...
        <section className="intro">
          ...
          <div className="introBio">
            ...
            ></img>
            <p>
              I'm a passionate front-end engineer with a strong interest in
              UI/UX, web, and interactive design & development. With over four
              years of professional experience, I've specialized in building
              intuitive, human-centered, and accessible digital products.
              <br />
              ...
              with faculty and staff to ensure the web experience supports the
              Law Schoo's academic initiatives and aligns with the university's
              strategic mission.
              <br />
              <br />
              Outside of work I am usually in the gym working on my fitness
              goals and cheering on my favorite sports teams — go Yankees, go
              Bills!
              <br />
